...
A lot of the times the Components you refer to here are going to be abstract infrastructure pieces, and you'd write your own application level code that utilizes these components
...
# The Rest
Outside of [Typical Components](/docs/architecture_components/typical_reusable_resources/) you simply discuss a large number of Components as they're seen "in the wild", and how you can reuse these
...
In these sections you discuss all of the different component types such as Databases & Storage, Messaging, and Data Warehousing
