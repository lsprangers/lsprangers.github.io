...
you design an entire [PubSub](/docs/architecture_components/typical_reusable_resources/typical_distributed_pubsub/index.md) System from scratch in this folder
