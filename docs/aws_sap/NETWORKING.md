...
- Longest prefix match
    ...
    - ![Longest Prefix](/img/vpc_longest_prefix.png)
...
- Using a Transit Gateway allows us to alleviate the problem in [VPC Peering](#vpc-peering) where you couldn't have a central NAT GW!
    ...
    - ![Central NAT GW](/img/central_natgw.png)
...
- Allows us to do Direct Connect to corporate data centers from multiple regions
    - ![Multi Region Direct Connect](/img/mr_directconnect.png)
...
- VPC Endpoints: Private connectivity to AWS services inside a VPC, there are two types 
    — Gateway (S3, DynamoDB; route table targets `vpce-*`)
...
![VPC Peering vs VPC Endpoints](/img/vpc_peering_vs_vpc_endpoints.png)       
...
- AWS Private Link then establishes a private link b/t ENI and NLB
    ...
    - ![Private Link Arch](/img/privatelink_arch.png)    
...
- Setup as AWS Direct Connect locations with customer cage + AWS Direct connect cage
    ...
    - ![Direct Connect Diagram](/img/direct_connect.png)
- Connection Types:
...
- ![Direct Connect GW](/img/direct_connect_gw.png)
