...
### Encoder Decoder
Encoder-Decoder frameworks are explained more in [Seq2Seq](/docs/transformer_and_llm/SEQ2SEQ.md#encoder-decoder)

These frameworks helped to setup underlying generative language models, and the section used to live here but ultimately is a different fundamental area. Encoder only models, like BERT, are extremely good at creating embeddings, and most encoder-decoder models like T5 are able to create embeddings, but are better suited at generative language tasks
