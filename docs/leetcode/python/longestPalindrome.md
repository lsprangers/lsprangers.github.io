...
def longestPalindrome(s: str) -> str:
    ...
    # Check for 3   
    # k is the length of substring you are checking - so you loop from 3 to n to check those length substrings
    # then you shift i and j k units at each step and 
    #   then when you check i+1 j-1 it's checking to see if the middle substring is a palindrome, and 
    ...
    #   and then you check s[i==j] which would be the outside letters
    k = 3
    while k <= n :
        i = 0
        # i goes up to n
