...
- Availabile: you can always give a shortened URL, and anyone can find the shortened URL for their origin 
- *Consistent: you don't want multiple short URL's to point to different original URL's, but the actual level of consistency depends
- Scalable: Same thing as always - in this case we'll choose higher consistency over higher availability, because let's say someone told us that's the design choice...you can design both ways

## Non-functional requirements
- URLs should have only alphanumeric components
- URLs should have a known maximum length, say 20 characters 
- you do not make choices around the actual websites it points to (could be nefarious websites)
